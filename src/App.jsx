import { HashRouter as Router, Routes, Route } from "react-router-dom"; // Removed Navigate import
...
import DashboardLayout from "./layout/DashboardLayout.jsx"; // Changed from ./layout/DashboardLayout (common mistake)
...
function App() {
  ...
  return (
    <Router>
      <Routes>
        {/* Public Routes */}
        {/* THIS IS THE CRITICAL CHANGE: Directly render Login at the root */}
